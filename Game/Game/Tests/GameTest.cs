...
namespace Game.Tests
{
    ...
    public class GameTest
    {
        ...
        {
            var game = new Logic.Game(Board.CreateEmpty(7, 6), null, null, 0);
        ...
        {
            var game = new Logic.Game(Board.CreateEmpty(6, 7), null, null, 0);
        ...
        {
            var game = new Logic.Game(Board.CreateEmpty(5, 7), null, null, 0);
        ...
        {
            var game = new Logic.Game(Board.Create(new[]
            {
                ".........",
                "....*....",
                "...*.*...",
        ...
        public void TestTrySpawnNew()
        {
            ...
            var game = new Logic.Game(board, null, new[] {unit}, 0);
        ...
        {
            var board = Board.CreateEmpty(10, 5);
            var game = new Logic.Game(board, null, new Unit[0], 0);
        ...
        public void TestMakeCommand()
        {
            ...
            var game = new Logic.Game(board, null, new[] { unit, unit2 }, 0);
