...
namespace ICFPC2015.Tests.Tests
{
    ...
    public class GameTest
    {
        ...
        {
            var game = new Game(Board.CreateEmpty(7, 6), null, null, 0, 0, 0, -1, -1);
        ...
        {
            var game = new Game(Board.CreateEmpty(6, 7), null, null, 0, 0, 0, -1, -1);
        ...
        {
            var game = new Game(Board.CreateEmpty(5, 7), null, null, 0, 0, 0, -1, -1);
        ...
        public void TestTrySpawnNew()
        {
            ...
            var game = new Game(board, null, new[] { unit }, 0, 0, 0, -1, -1);
        ...
        {
            var board = Board.CreateEmpty(10, 5);
            var game = new Game(board, null, new Unit[0], 0, 0, 0, -1, -1);
        ...
        public void TestMakeCommandWest()
        {
            ...
            var game = new Game(board, null, new[] { unit, unit2 }, 0, 0, 0, -1, -1);
        ...
        public void TestMakeCommandWithUpdatedScore()
        {
            ...
            var unit = Unit.Create(new Point(0, 0), new[] { new Point(0, 0), });
            var unit2 = Unit.Create(new Point(0, 0), new[] { new Point(0, 0), });
            var game = new Game(board, null, new[] { unit, unit2 }, 0, 12, 200, -1, -1);
